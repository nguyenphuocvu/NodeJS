...
export class My extends BaseField {
    ...
    @Column({
        ...
        type: "nvarchar",
        length: 20,
        nullable: false,  // default is false, nếu không khai báo nó cũng mặc định là false
    }) 
    name: string
   ...
   //SQL: age smallint not null
    ...
    @Column()
    @Generated("uuid")
    uuid: string  //sinh ra một chuỗi không bao giờ trùng nhau và có thể dùng làm khóa chính
